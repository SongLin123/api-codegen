...
export default ({ request, requestForMock, mock, tools, moduleName }) => ({
  ...
  */
  AA_SS_DEVICEGROUP_ADDGROUP_POST({body=undefined,param=undefined,header=undefined,path=undefined}) {
    // 接口请求
    return request({
  ...
  */
  AA_SS_DEVICEGROUP_DELETEDEVICEGROUP_DELETE({body=undefined,param=undefined,header=undefined,path=undefined}) {
    // 接口请求
    return request({
  ...
  */
  AA_SS_DEVICEGROUP_GETDEVICEGROUPDETAIL_GET({body=undefined,param=undefined,header=undefined,path=undefined}) {
    // 接口请求
    return request({
  ...
  */
  AA_SS_DEVICEGROUP_GETGROUPTREE_GET({body=undefined,param=undefined,header=undefined,path=undefined}) {
    // 接口请求
    return request({
  ...
  */
  AA_SS_DEVICEGROUP_GETNEXTNODEGROUP_GET({body=undefined,param=undefined,header=undefined,path=undefined}) {
    // 接口请求
    return request({
  ...
  */
  AA_SS_DEVICEGROUP_UPDATEGROUP_PUT({body=undefined,param=undefined,header=undefined,path=undefined}) {
    // 接口请求
    return request({
