...
export default ({ request, requestForMock, mock, tools, moduleName }) => ({
  ...
  */
  AA_SS_PERSONGROUP_ADDPERSONGROUP_POST({body=undefined,param=undefined,header=undefined,path=undefined}) {
    // 接口请求
    return request({
  ...
  */
  AA_SS_PERSONGROUP_DELETEPERSONGROUP_DELETE({body=undefined,param=undefined,header=undefined,path=undefined}) {
    // 接口请求
    return request({
  ...
  */
  AA_SS_PERSONGROUP_GETCHILDPERSONGROUP_GET({body=undefined,param=undefined,header=undefined,path=undefined}) {
    // 接口请求
    return request({
  ...
  */
  AA_SS_PERSONGROUP_GETPERSONGROUP_1_GET({body=undefined,param=undefined,header=undefined,path=undefined}) {
    // 接口请求
    return request({
  ...
  */
  AA_SS_PERSONGROUP_UPDATEPERSONGROUP_PUT({body=undefined,param=undefined,header=undefined,path=undefined}) {
    // 接口请求
    return request({
