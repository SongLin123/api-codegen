...
export default ({ request, requestForMock, mock, tools, moduleName }) => ({
  ...
  */
  _DEVICEGROUP_ADDGROUP_POST({body=undefined,param=undefined,header=undefined,path=undefined}) {
    // 接口请求
    return request({
  ...
  */
  _DEVICEGROUP_DELETEDEVICEGROUP_DELETE({body=undefined,param=undefined,header=undefined,path=undefined}) {
    // 接口请求
    return request({
  ...
  */
  _DEVICEGROUP_GETDEVICEGROUPDETAIL_GET({body=undefined,param=undefined,header=undefined,path=undefined}) {
    // 接口请求
    return request({
  ...
  */
  _DEVICEGROUP_GETGROUPTREE_GET({body=undefined,param=undefined,header=undefined,path=undefined}) {
    // 接口请求
    return request({
  ...
  */
  _DEVICEGROUP_GETNEXTNODEGROUP_GET({body=undefined,param=undefined,header=undefined,path=undefined}) {
    // 接口请求
    return request({
  ...
  */
  _DEVICEGROUP_UPDATEGROUP_PUT({body=undefined,param=undefined,header=undefined,path=undefined}) {
    // 接口请求
    return request({
